"""
    fork from [Visual Semantic Reasoning](https://github.com/KunpengLi1994/VSRN/blob/master/GCN_lib/Rs_GCN.py)
"""
import torch
...
if __name__=="__main__":
    gcn_layers = 4
    model = nn.ModuleList([Rs_GCN(1024, 1024) for i in range(gcn_layers)])
    input = torch.rand([128,36,1024])
