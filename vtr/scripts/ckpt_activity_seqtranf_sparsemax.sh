...
videos_dir="/home/panzx/dataset/VideoDatasets/ActivityNet"
...
torchrun --nproc_per_node=3 main.py \
    ...
    --datatype activity --max_words 64 --max_frames 64 --video_framerate 1 \
    --base_encoder ViT-B/32 --agg_module seqTransf --interaction sparsemax \
    --output_dir ckpts/ckpt_activity_sparsemax