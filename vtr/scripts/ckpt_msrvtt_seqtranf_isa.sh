...
torchrun --nproc_per_node=2 train.py \
    ...
    --lr 1e-4 --coef_lr 1e-3 --batch_size 128 --batch_size_val 216 \
    ...
    --base_encoder ViT-B/32 --agg_module seqTransf --interaction isa \
    --cdcr_alpha1=0.0 --output_dir=ckpts/ckpt_msrvtt_seqtranf_isa